...
var _user$project$Main$viewCheckbox = function (_p0) {
	var _p1 = _p0;
	return A2(
		_evancz$elm_sortable_table$Table$HtmlDetails,
		{ctor: '[]'},
...
var _user$project$Main$checkboxColumn = _evancz$elm_sortable_table$Table$veryCustomColumn(
	{name: '', viewData: _user$project$Main$viewCheckbox, sorter: _evancz$elm_sortable_table$Table$unsortable});
var _user$project$Main$timeToString = function (time) {
...
var _user$project$Main$timeColumn = _evancz$elm_sortable_table$Table$customColumn(
	{
		name: 'Time',
		viewData: function (_p4) {
			return _user$project$Main$timeToString(
				function (_) {
					return _.time;
				}(_p4));
		},
...
var _user$project$Main$viewSummary = function (allSights) {
	var _p5 = A2(
	...
	if (_p5.ctor === '[]') {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Click the sights you want to see on your trip!'),
				_1: {ctor: '[]'}
			});
	} else {
		var _p6 = _p5;
		...
		var summary = A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Main$timeToString(time),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' of fun, costing $',
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						sights: A2(
							_elm_lang$core$List$map,
							_user$project$Main$toggle(_p7._0),
							model.sights)
					}),
...
var _user$project$Main$init = function (sights) {
	var model = {
		sights: sights,
		tableState: _evancz$elm_sortable_table$Table$initialSort('Year')
	};
...
var _user$project$Main$Sight = F5(
	function (a, b, c, d, e) {
		return {name: a, time: b, price: c, rating: d, selected: e};
	});
var _user$project$Main$missionSights = {
	ctor: '::',
	_0: A5(_user$project$Main$Sight, 'Eat a Burrito', 30 * _elm_lang$core$Time$minute, 7, 4.6, false),
	_1: {
		ctor: '::',
		_0: A5(_user$project$Main$Sight, 'Buy drugs in Dolores park', _elm_lang$core$Time$hour, 20, 4.8, false),
		_1: {
			ctor: '::',
			_0: A5(_user$project$Main$Sight, 'Armory Tour', 1.5 * _elm_lang$core$Time$hour, 27, 4.5, false),
			_1: {
				ctor: '::',
				_0: A5(_user$project$Main$Sight, 'Tartine Bakery', _elm_lang$core$Time$hour, 10, 4.1, false),
				_1: {
					ctor: '::',
					_0: A5(_user$project$Main$Sight, 'Have Brunch', 2 * _elm_lang$core$Time$hour, 25, 4.2, false),
					_1: {
						ctor: '::',
						_0: A5(_user$project$Main$Sight, 'Get catcalled at BART', 5 * _elm_lang$core$Time$minute, 0, 1.6, false),
						_1: {
							ctor: '::',
							_0: A5(_user$project$Main$Sight, 'Buy a painting at \"Stuff\"', 45 * _elm_lang$core$Time$minute, 400, 4.7, false),
							_1: {
								ctor: '::',
								_0: A5(_user$project$Main$Sight, 'McDonalds at 24th', 20 * _elm_lang$core$Time$minute, 5, 2.8, false),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Main$toRowAttrs = function (sight) {
	return {
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(
			_user$project$Main$ToggleSelected(sight.name)),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
...
var _user$project$Main$config = _evancz$elm_sortable_table$Table$customConfig(
	{
		...
		columns: {
			ctor: '::',
			_0: _user$project$Main$checkboxColumn,
			_1: {
				ctor: '::',
				_0: A2(
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$timeColumn,
					_1: {
						ctor: '::',
						_0: A2(
		...
		customizations: _elm_lang$core$Native_Utils.update(
			...
			{rowAttrs: _user$project$Main$toRowAttrs})
	});
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Trip Planner'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$viewSummary, _p10),
				_1: {
					ctor: '::',
					_0: A3(_evancz$elm_sortable_table$Table$view, _user$project$Main$config, _p9.tableState, _p10),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Main$init(_user$project$Main$missionSights),
